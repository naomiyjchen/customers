...
def step_impl(context, message):
    ...
    if message not in context.driver.title:
        print(f"Expected '{message}' to be in title, but it's not.")
...
def step_impl(context, name):
    element = context.driver.find_element(By.ID, "query_results")
